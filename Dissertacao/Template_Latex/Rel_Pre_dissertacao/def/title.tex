...
{\centering 
    ...
    \vspace{1cm}
    \textcolor{grey}{\textbf{Mestrado em Engenharia Informática}} \\
...
\flushleft{\textcolor{grey}{{\Large Relatório de pré-dissertação}}}
\vspace{0.5cm}

\flushleft{\textcolor{grey}{ \emph{Orientado por:}}
\vspace{0.2cm}
