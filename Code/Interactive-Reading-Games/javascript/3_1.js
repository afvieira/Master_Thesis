...
function loadSilabas() {
  ...
  group_s1.on('mousedown', function() {
    ...
    audioElement.setAttribute('src', audioSource['si']);
    audioElement.play();
    decreaseAnswer(1);
  });
  ...
  group_s2.on('mousedown', function() {
    ...
    var audioElement = document.createElement('audio');
    audioElement.setAttribute('src', audioSource['al']);
    audioElement.play();
    decreaseAnswer(2);
  });
  ...
  group_s3.on('mousedown', function() {
    ...
    var audioElement = document.createElement('audio');
    audioElement.setAttribute('src', audioSource['pul']);
    audioElement.play();
    decreaseAnswer(3);
  });
...
function loadWord() {
  fabric.Image.fromURL('../images/speaker.png', function(img) {
    ...
    img.on('mousedown', function() {
      var audioElement = document.createElement('audio');
      audioElement.setAttribute('src', audioSource['mao']);
      audioElement.play();
    });
  });
