...
function loadButton(_numResp, _tentativas, _left, _top) {
  var span, silaba;
  var colors = ['yellow'];
...
function loadSilabas() {
  ...
  var s1 = new fabric.Text('ve', {
    fontSize: 70,
    fontWeight: 'bold',
    shadow: 'rgba(0,0,0,0.2) 5px 5px 5px'
  });
  var s2 = new fabric.Text('bro', {
    fontSize: 70,
    fontWeight: 'bold',
    shadow: 'rgba(0,0,0,0.2) 5px 5px 5px'
  });
  var s3 = new fabric.Text('tan', {
    fontSize: 70,
    fontWeight: 'bold',
    shadow: 'rgba(0,0,0,0.2) 5px 5px 5px',
  });
  ...
  group_s1.on('mousedown', function() {
    ...
    audioElement.setAttribute('src', audioSource['ve']);
    audioElement.play();
    decreaseAnswer(1);
  });
  ...
  group_s2.on('mousedown', function() {
    ...
    var audioElement = document.createElement('audio');
    audioElement.setAttribute('src', audioSource['bro']);
    audioElement.play();
    decreaseAnswer(2);
  });
  ...
  group_s3.on('mousedown', function() {
    ...
    var audioElement = document.createElement('audio');
    audioElement.setAttribute('src', audioSource['tan']);
    audioElement.play();
    decreaseAnswer(3);
  });
...
function loadWord() {
  fabric.Image.fromURL('../images/speaker.png', function(img) {
    ...
    img.on('mousedown', function() {
      var audioElement = document.createElement('audio');
      audioElement.setAttribute('src', audioSource['fila']);
      audioElement.play();
    });
  });

  var text = new fabric.Text('Fila', {
    fontSize: 60,
    fontWeight: 'bold',
    shadow: 'rgba(0,0,0,0.2) 5px 5px 5px',
